...
import { Calendar, Filter, HomeIcon, Icon, Plus } from 'lucide-react'
      ...
      <div className={HEADER}>
        <div className='min-w-0'>
          <h1 className='text-xl md:text-3xl font-bold text-gray-800 flex items-center gap-2'>
            ...
            <span className='truncate'>Task Overwiew</span>
          </h1>
          <p className='text-sm text-gray-500 mt-1 ml-7 truncate'>Manage your tasks effeciently</p>
        </div>
