...
console.log("Tasks array:", arr);  // Debug here

setTasks(arr || []); // Always an array
                    ...
                    <div className='xl:col-span-1 space-y-4 sm:space-y-6'>
                        <div className='bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100'>
                            ...
                            <div className='grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6'>
                                <StatCard title={'Total Task'} value={stats.totalCount} icon={<Circle className='w-3.5 h-3.5 sm:w-4 sm:h-4 text-purple-500' />} />
                                ...
                                <StatCard title={'Percentage'} value={`${stats.completionPercentage}%`} icon={<Zap className='w-3.5 h-3.5 sm:w-4 sm:h-4 text-purple-500' />} />
                            </div>
                            ...
                            <div className='space-y-2 sm:space-y-3'>
                                <div className='flex items-center justify-between text-gray-700'>
                                    ...
                                    <span className='text-xs bg-purple-100 text-purple-700 px-1.5 py-0.5 sm:px-2 rounded-full'>{stats.completedTasks}/{stats.totalCount}</span>
                                </div>
